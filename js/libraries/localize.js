  ...
  .provider('localize', function localizeProvider() {
    ...
    this.$get = ['$http', '$rootScope', '$window', '$filter', function($http, $rootScope, $window, $filter) {
      ...
      var localize = {
        ...
        language: $window.navigator.userLanguage || $window.navigator.language, //- See more at: http://codingsmackdown.tv/blog/2012/12/14/localizing-your-angularjs-app/#sthash.suwS3UVG.dpuf,
      ...
      var i18NImageDirective = {
        ...
        link: function(scope, element, attrs) {
          ...
          localize.buildImgUrl(imageUrl).success(function() {
            ...
            element[0].src = '/i18N/images/default/' + i18Nsrc;
          });
        }
      };
